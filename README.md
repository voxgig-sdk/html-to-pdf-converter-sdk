...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/html-to-pdf-converter` | `npm install @voxgig-sdk/html-to-pdf-converter` |
| Python | `voxgig-sdk-html-to-pdf-converter` | `pip install voxgig-sdk-html-to-pdf-converter` |
| PHP | `voxgig-sdk/html-to-pdf-converter` | `composer require voxgig-sdk/html-to-pdf-converter` |
| Golang | `github.com/voxgig-sdk/html-to-pdf-converter-sdk/go` | `go get github.com/voxgig-sdk/html-to-pdf-converter-sdk/go` |
| Ruby | `voxgig-sdk-html-to-pdf-converter` | `gem install voxgig-sdk-html-to-pdf-converter` |
| Lua | `voxgig-sdk-html-to-pdf-converter` | `luarocks install voxgig-sdk-html-to-pdf-converter` |
