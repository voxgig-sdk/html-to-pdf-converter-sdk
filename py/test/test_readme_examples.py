# HtmlToPdfConverter SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions HtmlToPdfConverterSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both HtmlToPdfConverterSDK(...) and HtmlToPdfConverterSDK.test(...) become
#      HtmlToPdfConverterSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "htmltopdfconverter_sdk"
_SDK_CLASS = "HtmlToPdfConverterSDK"
