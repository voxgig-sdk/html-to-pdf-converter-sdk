...
from htmltopdfconverter_sdk.core.control import HtmlToPdfConverterControl
...
from htmltopdfconverter_sdk.core.helpers import get_ctx_prop, to_map
...
class HtmlToPdfConverterContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = HtmlToPdfConverterControl()
        ...
        if isinstance(sp, HtmlToPdfConverterSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, HtmlToPdfConverterResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, HtmlToPdfConverterResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return HtmlToPdfConverterOperation({})
        ...
        op = HtmlToPdfConverterOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return HtmlToPdfConverterError(code, msg, self)
