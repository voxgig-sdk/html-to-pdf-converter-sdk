...
from htmltopdfconverter_sdk.htmltopdfconverter_types import (
    PdfGeneration,
    PdfGenerationCreateData,
)
...
class PdfGenerationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PdfGenerationEntity(self._client, opts)
    ...
    def data_get(self) -> PdfGeneration:
    ...
    def match_get(self) -> PdfGeneration:
    ...
    def create(self, reqdata: PdfGenerationCreateData, ctrl=None) -> PdfGeneration:
        utility = self._utility
