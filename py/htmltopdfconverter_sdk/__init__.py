...
from htmltopdfconverter_sdk.utility import register

# Load features
from htmltopdfconverter_sdk.feature.base_feature import HtmlToPdfConverterBaseFeature
from htmltopdfconverter_sdk.features import _has_feature, _make_feature
...
class HtmlToPdfConverterSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = HtmlToPdfConverterUtility()
        self._utility = utility

        from htmltopdfconverter_sdk.config import shared_config
    ...
    def get_utility(self):
        return HtmlToPdfConverterUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("HtmlToPdfConverterSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def PdfGeneration(self, data=None) -> "PdfGenerationEntity":
        ...
        from htmltopdfconverter_sdk.entity.pdf_generation_entity import PdfGenerationEntity
