...
// HtmlToPdfConverter SDK audit feature
...
class HtmlToPdfConverterAuditFeature extends HtmlToPdfConverterBaseFeature
{
    ...
    private function _emit(HtmlToPdfConverterContext $ctx, string $outcome): void
    {
