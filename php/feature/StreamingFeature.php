...
// HtmlToPdfConverter SDK streaming feature
...
class HtmlToPdfConverterStreamingFeature extends HtmlToPdfConverterBaseFeature
{
    ...
    private function _iterate(HtmlToPdfConverterResult $result): \Generator
    {
    ...
    private function _streamable(HtmlToPdfConverterContext $ctx): bool
    {
