...
// HtmlToPdfConverter SDK telemetry feature
...
class HtmlToPdfConverterTelemetryFeature extends HtmlToPdfConverterBaseFeature
{
    ...
    private function _close(HtmlToPdfConverterContext $ctx, bool $ok): void
    {
