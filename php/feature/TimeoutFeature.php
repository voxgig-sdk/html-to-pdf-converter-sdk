...
// HtmlToPdfConverter SDK timeout feature
...
class HtmlToPdfConverterTimeoutFeature extends HtmlToPdfConverterBaseFeature
{
    ...
    private function _with_timeout(HtmlToPdfConverterContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(HtmlToPdfConverterContext $_ctx, float $ms): void
    {
        $client = $this->client;
