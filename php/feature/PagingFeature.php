...
// HtmlToPdfConverter SDK paging feature
...
class HtmlToPdfConverterPagingFeature extends HtmlToPdfConverterBaseFeature
{
    ...
    private function _is_list(HtmlToPdfConverterContext $ctx): bool
    {
