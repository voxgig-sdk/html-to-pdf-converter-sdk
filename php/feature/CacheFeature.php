...
// HtmlToPdfConverter SDK cache feature
...
class HtmlToPdfConverterCacheFeature extends HtmlToPdfConverterBaseFeature
{
    ...
    private function _through(HtmlToPdfConverterContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
