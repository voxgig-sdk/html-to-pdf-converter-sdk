...
// HtmlToPdfConverter SDK ratelimit feature
...
class HtmlToPdfConverterRatelimitFeature extends HtmlToPdfConverterBaseFeature
{
    ...
    private function _acquire(HtmlToPdfConverterContext $ctx): void
    {
    ...
    private function _track(HtmlToPdfConverterContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
