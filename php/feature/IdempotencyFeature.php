...
// HtmlToPdfConverter SDK idempotency feature
...
class HtmlToPdfConverterIdempotencyFeature extends HtmlToPdfConverterBaseFeature
{
    ...
    private function _mutating(HtmlToPdfConverterContext $ctx): bool
    {
