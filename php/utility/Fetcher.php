...
// HtmlToPdfConverter SDK utility: fetcher

class HtmlToPdfConverterFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; HtmlToPdfConverterSDK/1.0)';
    ...
    public static function call(HtmlToPdfConverterContext $ctx, string $fullurl, array $fetchdef): array
    {
