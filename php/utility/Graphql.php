...
// HtmlToPdfConverter SDK utility: graphql
//
...
class HtmlToPdfConverterGraphql
{
    ...
    // equivalent.
    public static function body(HtmlToPdfConverterContext $ctx): mixed
    {
    ...
    public static function errors(HtmlToPdfConverterContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
