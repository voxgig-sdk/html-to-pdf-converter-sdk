...
// HtmlToPdfConverter SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class HtmlToPdfConverterMakeRequest
{
    public static function call(HtmlToPdfConverterContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new HtmlToPdfConverterResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new HtmlToPdfConverterResponse($fetched);
        } else {
