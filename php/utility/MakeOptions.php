...
// HtmlToPdfConverter SDK utility: make_options

class HtmlToPdfConverterMakeOptions
{
    ...
    public static function call(HtmlToPdfConverterContext $ctx): array
    {
        ...
        //
        // `HtmlToPdfConverterSchema::optspec()` is built from the model:
        ...
        $optspec = HtmlToPdfConverterSchema::optspec();
