...
// HtmlToPdfConverter SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (HtmlToPdfConverterSDK::test)
...
{
    private const SDK_CLASS = 'HtmlToPdfConverterSDK';
    ...
    private const SDK_BASE = 'htmltopdfconverter_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../htmltopdfconverter_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
