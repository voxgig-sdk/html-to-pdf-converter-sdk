...
class HtmlToPdfConverterTestRunner
{
    ...
    {
        $live = self::getenv('HTML_TO_PDF_CONVERTER_TEST_LIVE');
        $override = self::getenv('HTML_TO_PDF_CONVERTER_TEST_OVERRIDE');
        ...
        $explain = self::getenv('HTML_TO_PDF_CONVERTER_TEST_EXPLAIN');
...
class_alias('HtmlToPdfConverterTestRunner', 'Runner');
class_alias('HtmlToPdfConverterHelpers', 'Helpers');
