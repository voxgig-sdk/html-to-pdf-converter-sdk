# HtmlToPdfConverter PHP SDK Reference

Complete API reference for the HtmlToPdfConverter PHP SDK.
...
#### `HtmlToPdfConverterSDK::test($testopts = null, $sdkopts = null)`
