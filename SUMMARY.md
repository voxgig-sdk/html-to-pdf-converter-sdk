...
Results: Successfully generated PDF file.
...
| --- | --- | --- | --- |
| PdfGeneration | `create` | `POST /generate` | See reference |

## Connect to the API

- Production server: `https://html2pdf.fly.dev/api`
...
- `html-to-pdf-converter_list`: List records for an entity. No active entity supports this operation.
- `html-to-pdf-converter_load`: Load one record for an entity. No active entity supports this operation.
