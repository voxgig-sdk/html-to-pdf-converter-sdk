...
class HtmlToPdfConverterTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = HtmlToPdfConverterTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = HtmlToPdfConverterTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = HtmlToPdfConverterTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
