...
// HtmlToPdfConverter SDK metrics feature
...
class HtmlToPdfConverterMetricsFeature extends HtmlToPdfConverterBaseFeature
{
    ...
    private function _record(HtmlToPdfConverterContext $ctx, bool $ok): void
    {
