...
// HtmlToPdfConverter SDK clienttrack feature
...
class HtmlToPdfConverterClienttrackFeature extends HtmlToPdfConverterBaseFeature
{
    ...
    public function PostConstruct(HtmlToPdfConverterContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'HtmlToPdfConverter-SDK';
