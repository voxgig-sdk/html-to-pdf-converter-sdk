...
// HtmlToPdfConverter SDK rbac feature
...
class HtmlToPdfConverterRbacFeature extends HtmlToPdfConverterBaseFeature
{
    ...
    private function _required(HtmlToPdfConverterContext $ctx): ?string
    {
    ...
    private function _reject(HtmlToPdfConverterContext $ctx, string $required): void
    {
    ...
    private function _track(HtmlToPdfConverterContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
