...
// HtmlToPdfConverter SDK proxy feature
...
class HtmlToPdfConverterProxyFeature extends HtmlToPdfConverterBaseFeature
{
    ...
    public function init(HtmlToPdfConverterContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (HtmlToPdfConverterContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
