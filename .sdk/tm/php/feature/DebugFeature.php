...
// HtmlToPdfConverter SDK debug feature
...
class HtmlToPdfConverterDebugFeature extends HtmlToPdfConverterBaseFeature
{
    ...
    private function _finish(HtmlToPdfConverterContext $ctx, bool $ok): void
    {
