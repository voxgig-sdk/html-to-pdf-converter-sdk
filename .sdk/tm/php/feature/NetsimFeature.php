...
// HtmlToPdfConverter SDK netsim feature
...
class HtmlToPdfConverterNetsimFeature extends HtmlToPdfConverterBaseFeature
{
    ...
    private function _simulate(HtmlToPdfConverterContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(HtmlToPdfConverterContext $ctx, array $applied): void
    {
        $client = $this->client;
