...
// HtmlToPdfConverter SDK utility: result_basic

class HtmlToPdfConverterResultBasic
{
    public static function call(HtmlToPdfConverterContext $ctx): ?HtmlToPdfConverterResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof HtmlToPdfConverterError) ? $result->err->msg : (string)$result->err;
