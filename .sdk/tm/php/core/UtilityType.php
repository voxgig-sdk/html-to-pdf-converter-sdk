...
// HtmlToPdfConverter SDK utility type

class HtmlToPdfConverterUtility
{
    ...
    public static function copy(HtmlToPdfConverterUtility $src): HtmlToPdfConverterUtility
    {
        $u = new HtmlToPdfConverterUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
