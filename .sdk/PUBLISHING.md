...
|---|---|---|
| `ts/` | @voxgig-sdk/html-to-pdf-converter-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/html-to-pdf-converter-sdk \
      --repository voxgig-sdk/html-to-pdf-converter-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/html-to-pdf-converter-sdk` shows it, and
`npm trust revoke @voxgig-sdk/html-to-pdf-converter-sdk --id=<id>` removes it.
