...
function runner.env_override(m)
  local live = runner.getenv("HTMLTOPDFCONVERTER_TEST_LIVE")
  local override = runner.getenv("HTMLTOPDFCONVERTER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("HTMLTOPDFCONVERTER_TEST_EXPLAIN")
