...
func registerSDKWords(r *eng.Registry, client *sdk.HtmlToPdfConverterSDK) {
...
func runOp(client *sdk.HtmlToPdfConverterSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
