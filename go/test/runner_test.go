...
func envOverride(m map[string]any) map[string]any {
	if os.Getenv("HTMLTOPDFCONVERTER_TEST_LIVE") == "TRUE" ||
		os.Getenv("HTMLTOPDFCONVERTER_TEST_OVERRIDE") == "TRUE" {
		for key := range m {
	...
	if explain := os.Getenv("HTMLTOPDFCONVERTER_TEST_EXPLAIN"); explain != "" {
