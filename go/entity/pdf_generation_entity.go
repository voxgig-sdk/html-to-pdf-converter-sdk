...
import (
	...
	vs "github.com/voxgig-sdk/html-to-pdf-converter-sdk/go/utility/struct"
)

type PdfGenerationEntity struct {
	name    string
	client  *core.HtmlToPdfConverterSDK
...
func NewPdfGenerationEntity(client *core.HtmlToPdfConverterSDK, entopts map[string]any) *PdfGenerationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PdfGenerationEntity) GetName() string { return e.name }
...
func (e *PdfGenerationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PdfGenerationEntity) Deleted() bool {
	return e.deleted
}


func (e *PdfGenerationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPdfGenerationEntity(e.client, opts)
}

func (e *PdfGenerationEntity) Data(args ...any) any {
...
func (e *PdfGenerationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PdfGeneration; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PdfGenerationEntity) DataTyped(data ...PdfGeneration) PdfGeneration {
	if len(data) > 0 {
		return typedFrom[PdfGeneration](e.Data(asMap(data[0])))
	}
	return typedFrom[PdfGeneration](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PdfGeneration (all fields
// optional at the wire level).
func (e *PdfGenerationEntity) MatchTyped(match ...PdfGeneration) PdfGeneration {
	if len(match) > 0 {
		return typedFrom[PdfGeneration](e.Match(asMap(match[0])))
	}
	return typedFrom[PdfGeneration](e.Match())
}
...
func (e *PdfGenerationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PdfGenerationEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *PdfGenerationEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *PdfGenerationEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PdfGenerationCreateData and returns an PdfGeneration. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *PdfGenerationEntity) CreateTyped(reqdata PdfGenerationCreateData, ctrl map[string]any) (PdfGeneration, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return PdfGeneration{}, err
	}
	return typedFrom[PdfGeneration](res), nil
}



func (e *PdfGenerationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PdfGenerationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PdfGenerationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
