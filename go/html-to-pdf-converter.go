...
// instead of `sdk.NewHtmlToPdfConverterSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *HtmlToPdfConverterSDK  { return NewHtmlToPdfConverterSDK(nil) }
func Test() *HtmlToPdfConverterSDK { return TestSDK(nil, nil) }
