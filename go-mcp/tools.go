...
type Args struct {
	Entity string         `json:"entity" jsonschema:"pdf_generation"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.HtmlToPdfConverterSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "html-to-pdf-converter_list",
		Description: "List records from HtmlToPdfConverter. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "html-to-pdf-converter_load",
		Description: "Load a single record from HtmlToPdfConverter. " +
...
func runOp(client *sdk.HtmlToPdfConverterSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.HtmlToPdfConverterSDK, name string) (sdk.HtmlToPdfConverterEntity, error) {
	switch strings.ToLower(name) {
	case "pdf_generation":
		return client.PdfGeneration(nil), nil
