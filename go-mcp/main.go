// Command HtmlToPdfConverter-mcp is an MCP server exposing the HtmlToPdfConverter
// SDK as MCP tools.
//
// Two tools are registered:
//
//	HtmlToPdfConverter_list  — list records of an entity
//	HtmlToPdfConverter_load  — load a single record of an entity
//
