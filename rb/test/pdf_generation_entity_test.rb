...
class PdfGenerationEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set HTMLTOPDFCONVERTER_TEST_PDF_GENERATION_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def pdf_generation_basic_setup(extra)
  ...
  entid_env_raw = ENV["HTMLTOPDFCONVERTER_TEST_PDF_GENERATION_ENTID"]
