...
#      offline in seeded test mode (HtmlToPdfConverterSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "HtmlToPdfConverter_sdk.rb")
  SDK_CLASS = "HtmlToPdfConverterSDK"
  ...
  SDK_BASE = "HtmlToPdfConverter_sdk"
